...
template = env.get_template('template_p1.html')#Choose Jinja template
...
with open('C:/Users/94070/Desktop/499/chatgpt_answers1.txt', 'w', encoding='utf-8') as file:#Save location
