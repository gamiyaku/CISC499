...
template = env.get_template('template_T5.html')#Choose Jinja template
...
with open('C:/Users/94070/Desktop/499/499_Train/chatgpt_T5.txt', 'w', encoding='utf-8') as file:#Save location
