...
template = env.get_template('template_T7.html')#Choose Jinja template


# Generate serious of formula
formulas = [generate_formula(random.randint(1, 10)) for _ in range(100)]  # Generate any number of formula here
...
with open('C:/Users/94070/Desktop/499/499_Train/chatgpt_T7_1.txt', 'w', encoding='utf-8') as file:#Save location
    api_key = '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'
