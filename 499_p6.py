...
template = env.get_template('template_p6.html')#Choose Jinja template
...
with open('C:/Users/94070/Desktop/499/chatgpt_answers6.txt', 'w', encoding='utf-8') as file:#Save location
